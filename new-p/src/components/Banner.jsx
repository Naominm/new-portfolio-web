    ...
    <section id='home' className='min-h-[85vh] lg:min-h-[75vh] flex items-center'>
     ...
     <div className='container mx-auto p-5 '>
        ...
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
          ...
          <p className='mb-12 max-w-lg mx-auto lg:mx-0'>I specialize in creating stunning websites and intuitive user interfaces. With a passion for
          design and a commitment to quality, I ensure every project I undertake exceeds expectations.</p>
                  
          <div className='flex max-w-max lg:mx-0 mx-auto  gap-x-6 items-center mb-16'>
                   
          <a href="https://drive.google.com/file/d/1kauRosxVgY6ddRol1oTW8RKWVQESaBDp/view?usp=sharing"  target='_bank'>
          ...
          <div className='flex text-2xl max-w-max gap-x-6 mx-auto mb-10 lg:mx-0 cursor-pointer'>
                  ...
                  <a href="https://github.com/Naominm"  target='_blank'rel='noreferrer'>
                    <FaGithub className='text-white'/>
                  </a>

                  <a href="https://www.linkedin.com/in/naomi-mbugua-b18984245/" target='_blank'rel='noreferrer'>
                    <FaLinkedin className='text-white'/>
                  </a>

                  <a href="https://wa.me/+254703937319"target='_blank'rel='noreferrer'>
        ...
        <div className="homeContainerPic">
            <div className="homeImageBoarder">
              <div className="homeImage">
                <img src={profile} alt="A profile of a dark lady" />
              </div>
            </div>
          </div>
